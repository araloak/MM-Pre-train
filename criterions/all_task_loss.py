...
@register_criterion("all_task_loss", dataclass=CrossEntropyCriterionConfig)
    ...
    def forward(self, model, sample, reduce=True):
        ...
        if sample["net_input"]["isl_mlm"] == True:
            if sample["net_input"]["tso"]!=True:
                ...
                total_loss += isl_mlm_loss
        if sample["net_input"]["isl"] == True:
            if sample["net_input"]["tso"]!=True and sample["net_input"]["isl_mlm"]!=True:
                sample_size = isl_sample_size
                total_loss = isl_loss
            else:
                total_loss += isl_loss
        if sample["net_input"]["cls"] == True:
            if sample["net_input"]["tso"]!=True and sample["net_input"]["isl_mlm"]!=True and sample["net_input"]["isl"]!=True:
